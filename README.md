...
For example, suppose we have to store a bank statement of customer. We can use arrays we can store it easily. This helps in reducing the use of number of variables as we don’t need to create a separate variable for every credit or debot. All records can be accessed by simply traversing the array. 
